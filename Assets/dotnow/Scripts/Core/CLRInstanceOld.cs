...
namespace dotnow
{
    public class CLRInstanceOld
    {
        ...
        // Constructor
        public CLRInstanceOld(CLRType type)
        {
            this.type = type;
        }
        ...
        internal static CLRInstanceOld CreateAllocatedInstance(AppDomain domain, CLRType type)
        {
            // Create instance
            CLRInstanceOld instance = new CLRInstanceOld(type);
            instance.Allocate(domain);

            return instance;
        }

        internal static CLRInstanceOld CreateAllocatedInstance(AppDomain domain, CLRType type, ConstructorInfo ctor, object[] args)
        {
            // Create instance
            CLRInstanceOld instance = new CLRInstanceOld(type);
            instance.Allocate(domain);
        ...
        internal static CLRInstanceOld CreateAllocatedInstanceWithProxy(AppDomain domain, CLRType type, ICLRProxy proxy)
        {
            // Create instance
            CLRInstanceOld instance = new CLRInstanceOld(type);
        ...
        internal static CLRInstanceOld CreateAllocatedInstanceWithProxy(AppDomain domain, CLRType type, CLRConstructor ctor, object[] args, ICLRProxy proxy)
        {
            // Create instance
            CLRInstanceOld instance = new CLRInstanceOld(type);
            instance.Allocate(domain, proxy);
